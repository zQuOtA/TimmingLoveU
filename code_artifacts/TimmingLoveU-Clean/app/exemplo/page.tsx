...
const exampleData = {
  ...
  dataInicioRelacao: new Date('2022-03-15'), // March 15, 2022
}
      ...
      <section className="relative py-32 px-4 text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-2 text-gray-500 mb-8 animate-slide-up" style={{animationDelay: '0.2s'}}>
            ...
            <span>Juntos desde 15 de março de 2022</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-romantic-hero">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Entre em contato para criar sua própria página personalizada e celebre seu amor de forma única!
          </p>
      ...
      <footer className="bg-white/80 border-t border-pink-100 py-8 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-sm">
            Esta é uma página de exemplo. Entre em contato para criar a sua!
          </p>
        </div>
      </footer>
    </div>
