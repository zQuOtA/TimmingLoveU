...
import { ArrowLeft, Mail, Lock, Heart, Eye, EyeOff } from 'lucide-react'
    ...
    <div className="min-h-screen bg-romantic-gradient">
      ...
      <header className="w-full bg-white/80 backdrop-blur-sm border-b border-pink-100">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <h1 className="text-xl font-romantic font-bold text-gray-800">Entrar</h1>
          <div></div>
        </div>
      </header>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl shadow-pink-100/50 border border-pink-100">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Acesse sua conta e continue celebrando seu amor
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    className="rounded border-pink-300 text-pink-600 shadow-sm focus:ring-pink-500"
                  />
